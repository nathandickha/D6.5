...
export class CausticsSystem {
  constructor() {
    ...
    // Artistic controls
    this.baseStrength = 0.72;  // boosted default intensity
    this.baseScale = 1.32;     // boosted default scale (denser webbing)
    this.baseSpeed = 0.46;     // slightly faster default
  ...
  applyToMaterial(mat) {
    ...
    mat.onBeforeCompile = (shader, renderer) => {
      ...
      shader.uniforms.uCausticsChroma      = { value: 0.008 };
