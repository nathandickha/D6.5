...
export function createPoolWater(a, b, geometryOverride = null) {
  ...
  const uniforms = {
    ...
    absorption: { value: new THREE.Color(0.72, 0.30, 0.10) },
    absorptionStrength: { value: 0.038 },
    ...
    shallowColor: { value: new THREE.Color(0.035, 0.18, 0.22) },
    deepColor:    { value: new THREE.Color(0.00, 0.055, 0.16) },
...
void main(){
  ...
  float scatterAmount = clamp((1.0 - dot(trans, vec3(0.3333333))) * scatterResponse, 0.0, 0.34);
